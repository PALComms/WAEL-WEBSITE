...
export default function PrivacyHeader() {
  ...
  return (
    <section ref={containerRef} className="w-full overflow-hidden">
      {/* Content Section */}
      <motion.div
        className="flex flex-col lg:flex-row justify-around items-center  py-6 px-4 md:px-8 lg:px-12 gap-8 lg:gap-12"
      ...
      >
        ...
        >
          <motion.h1
            className="text-4xl lg:text-5xl w-94 font-normal text-gray-900 leading-tight"
            initial={{ opacity: 0, y: 30 }}
            animate={isInView ? { opacity: 1, y: 0 } : {}}
        ...
        >
          ...
          >
            West Atlantic Energy Nigeria Limited Is Committed to Protecting Your
            Personal Data.
          </motion.p>
        </motion.div>
      </motion.div>
