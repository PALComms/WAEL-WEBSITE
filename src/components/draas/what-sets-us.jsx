...
export default function WhatSetsUs() {
  ...
  const benefits = [
    {
      id: 1,
      title: "We never undersize your storage",
      bgColor: "bg-[#E6F4FE]",
    ...
    {
      id: 2,
      title: "Zero Charge To Recover From The Cloud",
      bgColor: "bg-[#F0F0F0]",
    ...
    {
      id: 3,
      title: "High Availability wherever you operate",
      bgColor: "bg-[#FFFAB8]",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 p-6">
          {benefits.map((benefit, index) => (
            ...
            >
              <div className="flex flex-col items-start h-full space-x-4">
                {/* Animated Number */}
                <motion.div
                ...
                {/* Content */}
                <motion.p 
                  className={`${benefit.textColor} font-medium mt-auto text-2xl md:text-[45px] leading-relaxed`}
                  initial={{ opacity: 0 }}
