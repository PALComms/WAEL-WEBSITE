...
export default function QorumRansom() {
  ...
  return (
    <section
      className="md:min-h-screen flex flex-col  md:px-40 items-start  px-4  py-20 bg-gray-50"
      style={{
      ...
      >
        ...
        >
          <Link href="https://v4c2s15ufwd.typeform.com/to/Zv3iFqSp" target="_blank" rel="noopener noreferrer">
            ...
            >
              Conduct a Risk Assessment test today{" "}
            </motion.div>
          </Link>
        </motion.div>
      </motion.div>{" "}
