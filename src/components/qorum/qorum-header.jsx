...
export default function DraasHeader() {
  ...
  return (
    <header
      className="h-[75vh] flex flex-col py-24 justify-end"
      style={{
      ...
      >
        ...
        <motion.div variants={slideUpVariants}>
          <p className="text-md max-w-3xl text-white m-auto md:text-lg mb-8">
            Enterprise-grade Disaster Recovery as a Service (DRaaS) with instant
            recovery, immutable backups, and compliance-ready protection.
          </p>
        </motion.div>
