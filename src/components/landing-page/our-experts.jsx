  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 -mt-24 text-center text-white max-w-7xl mx-auto">
        ...
        >
          Ready to enhance your operations? Let's discuss your specific needs
          and build a solution that ensures safety, compliance, and business
          continuity.
        </motion.p>

        {/* CTA Button */}
        <motion.button
          className="bg-[#FFE629] text-[#202020] cursor-pointer px-8 py-4 rounded-full font-bold text-lg md:text-xl shadow-lg group relative overflow-hidden"
